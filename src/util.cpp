...
int nAnonymizePleskovAmount = 1000;
...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\Pleskov
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\Pleskov
    // Mac: ~/Library/Application Support/Pleskov
    // Unix: ~/.Pleskov
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Pleskov";
#else
    fs::path pathRet;
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "Pleskov.conf"));
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "Pleskovd.pid"));
